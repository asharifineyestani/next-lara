...
//               "description" =>"ایده های جدید دنیا های جدید رو کشف می کنند",
    ...
    public function webDevelopment()
    {
        ...
        $story = [
            "heading" => [
                "title" => "فرآیند توسعه وب اپلیکیشین در افرانکست چگونه است؟",
                "description" => "ما در هر مرحله از همکاری به مشتریان خود خدمات جامع و پشتیبانی حرفه ای ارائه خواهیم داد",
                "position" => "center",
            ],
            "image" => "assets/images/story/design-process.png",
            "items" => [
        ...
        $feature2 = [
            "heading" => [
                "title" => "ایده های شما با مدرن ترین هسته های تکنولوژی پیاده خواهند شد",
                "description" => "ما از مدرن ترین ابزارهای به توسعه استفاده می کنیم تا بالاترین استانداردها را به شما ارائه دهیم.",
                "position" => "center",
            ],
            "items" => [
                [
    ...
    public function mobileDevelopment()
    {
        ...
        $hero = [
            "heading" => [
                "h1" => "توسعه موبایل اپلیکیین",
                "subTitle" => "به دنیای موبایل ها وارد شوید. توسعه اپلیکیشن های تاثیرگذار تخصص ما است.",
                "description" => "از رویکرد جامع ما برای راه حلهای خاص این صنعت استفاده کنید. ما با در نظر گرفتن تمام نیازهای تجاری ، برنامه های cross-platform  و native  را به مشتریان خود ارائه می دهیم. ما از ابتکاری ترین فناوری ها برای افزایش امنیت کسب و کار ، بهبود عملکردهای کلیدی و ارائه یک تجربه کاربری استثنایی برای مشتریان استفاده می کنیم.",
                "position" => null,
                "className" => "",
                "label" => "",
            ],
        ...
        $feature = [
            "heading" => [
                "title" => "ما در استفاده از ری اکت نیتیو و فلاتر متخصص هستیم",
                "position" => "center",
            ],
            "items" => [
                [
                    "title"=>"تحوصل سریع ",
                    "description"=>"ما با مجموعه ابزارهایی که در دست داریم می دانیم که در هر یک از مراحل بک-اند , فرانت-اند و تجربه کاربری, چگونه پروژه ی خود را در کمترین زمان ایجاد نماییم. ",
                    "image"=>"/assets/images/features/clock.png",
                ],
                [
                    "title"=>"رابط کاربری انعطاف پذیر",
                    "description"=>"تمرکز ما بر روی تجربه کاربری native است. طراحی ماژولار و معماری لایه ای ما اجازه می دهد تا تغییرات را بسیار سریع انجام دهیم که منجر به طراحی های رسا و قابل توجه تر می شود.",
                    "image"=>"/assets/images/features/responsive.png",
                ],
                [
                    "title"=>"کارایی فوق العاده",
                    "description"=>"ما برای رسیدن به بالاترین کارایی native حتی به کوچکترین وجوه تمایز هر یک از پلتفرم های IOS   و اندروید نظیر اسکرول, نویگیشن و جلوه های بصری توجه می کنیم.","image"=>"/assets/images/features/speed.png",
                ],
            ...
            "items" => [
                [
                    "heading" =>
                        [
                            "title" => "تخمین و برآورد",
                            "description" => "ما نیازهای شما را برای مواجهه با چالش جمع آوری و تحلیل می کنیم و با توجه به جدول زمانی و بودجه بهترین راه حل را ارائه می دهیم. به محض اینکه ویژگی ها و طراحی برنامه اصلی مشخص شد و توافقات لازم حاصل گشت، آماده هستیم تا سفر را شروع کنیم.",
                ...
                [
                    "heading" =>
                        [
                            ...
                            "description" => "براساس تجربه ای که پس از مرحله اول به دست آورده ایم ، به ساخت نمونه های اولیه قابل کلیک می پردازیم. ما مطمئن خواهیم شد که طراحی UI / UX محصول نهایی، بهترین انتخاب شما بوده است.",
                ...
                [
                    "heading" =>
                        [
                            ...
                            "description" => "طراحی ارتباط نزدیکی با روند توسعه دارد. ما توسعه را به بخش های کوچکتر تقسیم می کنیم تا به ما فرصتی دهد نتایج کار را پس از اتمام هر بخش به شما نشان دهیم و نظرات شما را در هر بخش بدست آوریم.",
                ...
                [
                    "heading" =>
                        [
                            "title" => "تست",
                            "description" => "فرآیند تست برای اطمینان از رسیدن به نسخه ای بی نقص ضروری است. تیم متخصصان ما وظیفه رفع ایرادات و نقص های احتمالی را بر عهده دارند. آن ها وظیفه دارند اطمینان حاصل کنند تا اپلیکیشن شما مانند ساعت کار می کند.",
                ...
                [
                    "heading" =>
                        [
                            "title" => "عرضه عمومی",
                            "description" => "پس از تمام کارها ، ما آماده هستیم تا محصول شما را به جهانیان نشان دهیم و لذت بخش ترین تجربه کاربری را برای مشتریان خود تحویل دهیم.",
                ...
                [
                    "heading" =>
                        [
                            "title" => "پشتیبانی",
                            "description" => "پس از انتشار محصول ، ما از برنامه شما پشتیبانی می کنیم تا نیازهای کاربران نهایی را در آینده برآورده کنیم. تیم ما در هر زمان با شما در تماس است و آماده کمک به هر مسئله ای می باشد.",
